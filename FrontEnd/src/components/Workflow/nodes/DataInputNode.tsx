...
export default function DataInputNode({ data }: any) {
  return (
    <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-4 min-w-[180px]">
      <div className="flex items-center gap-2 mb-2">
        <CloudArrowDownIcon className="h-5 w-5 text-blue-600" />
        <div className="font-semibold text-blue-900">Data Input</div>
      </div>
